                ...
                {windowSize.current < 576 &&
                    <>
                        ...
                        <div className={showMenu ? "nav-item mobile-menu visible" : "mobile-menu nav-item"}>
                            ...
                            <FontAwesomeIcon icon={faXmark} className='close' style={{ color: 'red' }} onClick={menuClickHandler} />
                        </div>
                        <svg id="wave" style={{
                            transform: 'rotate(180deg)',
                            transition: '0.3s',
